...
class PrefsDao @Inject constructor(private val sharedPreferences: SharedPreferences) {
  fun toggleSetWallpaperAutomatically() {
    val shouldSetWallpaperAutomatically = shouldSetWallpaperAutomatically()
    sharedPreferences.edit().putBoolean(SET_AUTOMATICALLY, !shouldSetWallpaperAutomatically).apply()
  }
